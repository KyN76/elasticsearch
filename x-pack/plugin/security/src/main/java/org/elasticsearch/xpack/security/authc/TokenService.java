...
public final class TokenService {
    ...
    static final int LEGACY_MINIMUM_BASE64_BYTES = Double.valueOf(Math.ceil((double) (4 * LEGACY_MINIMUM_BYTES) / 3)).intValue();
    public static final int MINIMUM_BASE64_BYTES = Double.valueOf(Math.ceil((double) (4 * MINIMUM_BYTES) / 3)).intValue();
